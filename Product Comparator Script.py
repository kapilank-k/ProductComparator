...
def extract_material(text):
    prompt = f"""
Extract the material type from the following product description. 
Return only the material name like "TMT", "OPC", "PC Strand", or something else.
...
def extract_form(text):
    prompt = f"""
From the product description below, extract the form type (e.g., Loose, Bag, Straight bars, Coil, Bundle, etc.).
If the form is not clear, return "Unknown".
